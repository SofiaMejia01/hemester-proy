            ...
            <nav class="col-12 col-md-2 bg-primary text-light p-3 vh-100">
                <ul class="nav flex-column">
                    <li class="nav-item sidebar-item py-2">
                        <a class="nav-link text-light" href="produccion_op.php">Producción</a>
                    </li>
                </ul>
            </nav>

            <main class="col-12 col-md-10 p-4">
                <h1 class="text-center">Bienvenido al Menú de Operador</h1>
                <p class="text-center">Aquí puedes gestionar todas tus operaciones de Producción.</p>
