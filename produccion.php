            ...
            <nav class="col-12 col-md-2 bg-primary text-light p-3 vh-100">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item sidebar-item py-2">
                        <a class="nav-link text-light" href="conf_prod.php">Configuración Producción</a>
                    </li>
                    <li class="nav-item sidebar-item py-2">
                        <a class="nav-link text-light" href="proc_preparacion.php">Proceso de Preparación</a>
                    </li>
