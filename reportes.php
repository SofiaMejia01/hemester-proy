        ...
        <div class="row vh-100">
            <nav class="col-12 col-md-2 bg-primary text-light p-3 vh-100">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item sidebar-item py-2">
                        <a class="nav-link text-light" href="reporte_compra_venta.php">Reporte de Compras y Ventas</a>
                    </li>
                    <li class="nav-item sidebar-item py-2">
                        <a class="nav-link text-light" href="reporte_valoracion_producto.php">Reporte de Valoración de Productos</a>
                    </li>
